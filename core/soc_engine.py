...
# Фазы параллельного зажигания: слоты с разными портами запускаются одновременно.
# Фаза 0 [1]:   Shani(Head/8081)  — DO, устанавливает фрейм.
# Фаза 1 [2,4]: Chandra(Heart/8082) || Mangala(Body/8083) — RE||FA, разные порты.
# Фаза 2 [3,5]: Shukra(Heart/8082) || Budha(Head/8081)   — MI||SOL, разные порты.
# Фаза 3 [6]:   Rahu(Head/8081)   — LA, дивергентный поиск по итогам.
FOHATIC_PHASES: list[list[int]] = [[1], [2, 4], [3, 5], [6]]
